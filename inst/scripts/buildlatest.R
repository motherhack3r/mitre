...
print(paste0("Saving in ", path.datasets, "beta/", file.current))
saveRDS(object = mitredata, file = paste0(path.datasets, "beta/", file.current))
print(paste0("Saving in ", path.datasets, "latest/", file.latest))
saveRDS(object = mitredata, file = paste0(path.datasets, "latest/", file.latest))
