...
col2predict <- "cpe_lite"
seed <- 43
num_samples <- 18000  # Number of samples to train on.
...
activation_function <- "softmax" # relu, sigmoid, softmax, softplus, softsign, tanh, selu, elu, exponential
...
df <- mitre::nlp_cpe_dataset(only_wfn = T)
df$cpe_lite <- paste(df$vendor, df$product, df$version, sep = ":")

```

# Example with CPE "lite"
...
cpes$cpe_lite <- paste(cpes$vendor, cpes$product, cpes$version, sep = ":")
