...
```{r }
input_characters  <- sort(unique(ml_cpe_valid_chars()))
target_characters <- sort(unique(tolower(ml_cpe_valid_chars(add_tab = T, add_enter = T))))
