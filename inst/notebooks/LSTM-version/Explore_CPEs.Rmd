...
STRATEGY: Analyze characters used in official data.
          At the end, two data sets are created, defining the charset used in
          RNN for input and output layers.
...
cpes <- cpes %>% select(title, vendor, product, version)
